...
extension BuildContextExtension<T> on BuildContext {
  ...
  String trNote(String key) => appLocale.textNoteLocale.getText(key);
  ...
  String trSafe(String key) {
    ...
    final translations = {
      ...appLocaleRead.authLocale.getText(key) != key
          ? {key: appLocaleRead.authLocale.getText(key)}
          : {},
      ...appLocaleRead.homeLocale.getText(key) != key
          ? {key: appLocaleRead.homeLocale.getText(key)}
          : {},
      ...appLocaleRead.settingsLocale.getText(key) != key
          ? {key: appLocaleRead.settingsLocale.getText(key)}
          : {},
      ...appLocaleRead.categoryLocale.getText(key) != key
          ? {key: appLocaleRead.categoryLocale.getText(key)}
          : {},
      ...appLocaleRead.createAccountLocale.getText(key) != key
          ? {key: appLocaleRead.createAccountLocale.getText(key)}
          : {},
      ...appLocaleRead.detailsLocale.getText(key) != key
          ? {key: appLocaleRead.detailsLocale.getText(key)}
          : {},
      ...appLocaleRead.otpLocale.getText(key) != key
          ? {key: appLocaleRead.otpLocale.getText(key)}
          : {},
      ...appLocaleRead.passwordGeneratorLocale.getText(key) != key
          ? {key: appLocaleRead.passwordGeneratorLocale.getText(key)}
          : {},
      ...appLocaleRead.statisticLocale.getText(key) != key
          ? {key: appLocaleRead.statisticLocale.getText(key)}
          : {},
      ...appLocaleRead.sidebarLocale.getText(key) != key
          ? {key: appLocaleRead.sidebarLocale.getText(key)}
          : {},
      ...appLocaleRead.onboardingLocale.getText(key) != key
          ? {key: appLocaleRead.onboardingLocale.getText(key)}
          : {},
      ...appLocaleRead.loginLocale.getText(key) != key
          ? {key: appLocaleRead.loginLocale.getText(key)}
          : {},
      ...appLocaleRead.errorLocale.getText(key) != key
          ? {key: appLocaleRead.errorLocale.getText(key)}
          : {},
      ...appLocaleRead.aboutLocale.getText(key) != key
          ? {key: appLocaleRead.aboutLocale.getText(key)}
          : {},
      ...appLocaleRead.textNoteLocale.getText(key) != key
          ? {key: appLocaleRead.textNoteLocale.getText(key)}
          : {},
    };
