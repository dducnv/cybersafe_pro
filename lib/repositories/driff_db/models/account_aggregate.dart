...
class AccountAggregate {
  ...
  static AccountAggregate fromOldDataJson(Map<String, dynamic> json) {
    ...
    final AccountDriftModelCompanion accountDriftModelCompanion = AccountDriftModelCompanion(
      id: Value(json['id'] is int ? json['id'] ?? 0 : int.tryParse(json['id']?.toString() ?? '') ?? 0),
      ...
      createdAt: Value(json['createdAt'] != null ? DateTime.tryParse(json['createdAt'].toString()) ?? DateTime.now() : DateTime.now()),
      updatedAt: Value(json['updatedAt'] != null ? DateTime.tryParse(json['updatedAt'].toString()) ?? DateTime.now() : DateTime.now()),
      passwordUpdatedAt: Value(json['passwordUpdatedAt'] != null ? DateTime.tryParse(json['passwordUpdatedAt'].toString()) ?? DateTime.now() : DateTime.now()),
    );

    final categoryJson = json['category'] as Map<String, dynamic>? ?? {};
    final category = CategoryDriftModelData(
      id: categoryJson['id'] is int ? categoryJson['id'] ?? 0 : int.tryParse(categoryJson['id']?.toString() ?? '') ?? 0,
      categoryName: categoryJson['categoryName']?.toString() ?? '',
      indexPos: categoryJson['indexPos'] is int ? categoryJson['indexPos'] ?? 0 : int.tryParse(categoryJson['indexPos']?.toString() ?? '') ?? 0,
      createdAt: categoryJson['createdAt'] != null ? DateTime.tryParse(categoryJson['createdAt'].toString()) ?? DateTime.now() : DateTime.now(),
      updatedAt: categoryJson['updatedAt'] != null ? DateTime.tryParse(categoryJson['updatedAt'].toString()) ?? DateTime.now() : DateTime.now(),
    );
    ...
    final customFieldsList = (json['customFields'] as List<dynamic>? ?? []).map((fieldJson) {
      ...
      fieldData['accountId'] = fieldData['accountId'] is int
        ? fieldData['accountId']
        : int.tryParse(fieldData['accountId']?.toString() ?? '') ?? accountDriftModelCompanion.id.value ?? 0;
      ...
      fieldData['id'] = fieldData['id'] is int ? fieldData['id'] : int.tryParse(fieldData['id']?.toString() ?? '') ?? 0;
    ...
    if (json['totp'] != null) {
      ...
      totpJson['accountId'] = totpJson['accountId'] is int
        ? totpJson['accountId']
        : int.tryParse(totpJson['accountId']?.toString() ?? '') ?? accountDriftModelCompanion.id.value ?? 0;
      totpJson['id'] = totpJson['id'] is int ? totpJson['id'] : int.tryParse(totpJson['id']?.toString() ?? '') ?? 0;
      totpJson['secretKey'] = totpJson['secretKey']?.toString() ?? '';
      totpJson['isShowToHome'] = totpJson['isShowToHome'] ?? false;
      totpJson['createdAt'] = totpJson['createdAt'] != null ? totpJson['createdAt'].toString() : DateTime.now().toIso8601String();
      totpJson['updatedAt'] = totpJson['updatedAt'] != null ? totpJson['updatedAt'].toString() : DateTime.now().toIso8601String();
    ...
    if (json['iconCustom'] != null) {
      ...
      iconJson['id'] = iconJson['id'] is int ? iconJson['id'] ?? 0 : int.tryParse(iconJson['id']?.toString() ?? '') ?? 0;
    ...
    if (json['passwordHistories'] != null) {
      passwordHistories = (json['passwordHistories'] as List<dynamic>).map((historyJson) {
        ...
        historyData['accountId'] = historyData['accountId'] is int
          ...
          : int.tryParse(historyData['accountId']?.toString() ?? '') ?? accountDriftModelCompanion.id.value ?? 0;
        historyData['id'] = historyData['id'] is int ? historyData['id'] : int.tryParse(historyData['id']?.toString() ?? '') ?? 0;
        historyData['password'] = historyData['password']?.toString() ?? '';
        historyData['createdAt'] = historyData['createdAt'] != null ? historyData['createdAt'].toString() : DateTime.now().toIso8601String();
