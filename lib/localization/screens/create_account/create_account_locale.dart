...
class CreateAccountLocale extends BaseLocale {
  ...
  Map<String, String> get vi => {
    ...
    CreateAccountText.overwritePasswordMessage: 'Mật khẩu cũ sẽ bị xóa và tạo mật khẩu mới!',
  ...
  Map<String, String> get en => {
    ...
    CreateAccountText.overwritePasswordMessage: 'The old password will be deleted and a new password will be created!',
  ...
  Map<String, String> get pt => {
    ...
    CreateAccountText.overwritePassword: 'Substituir senha',
    CreateAccountText.overwritePasswordMessage: 'A senha antiga será deletada e uma nova senha será criada!',
  ...
  Map<String, String> get hi => {
    ...
    CreateAccountText.overwritePasswordMessage: 'पुराने पासवर्ड को हटाया जाएगा और एक नया पासवर्ड बनाया जाएगा!',
  ...
  Map<String, String> get ja => {
    ...
    CreateAccountText.overwritePassword: 'パスワードを上書きしますか？',
    CreateAccountText.overwritePasswordMessage: '古いパスワードは削除され、新しいパスワードが作成されます！',
  ...
  Map<String, String> get ru => {
    ...
    CreateAccountText.overwritePasswordMessage: 'Старый пароль будет удален, и будет создан новый пароль!',
  ...
  Map<String, String> get id => {
    ...
    CreateAccountText.overwritePassword: 'Ganti kata sandi',
    CreateAccountText.overwritePasswordMessage: 'Kata sandi lama akan dihapus dan akan dibuat kata sandi baru!',
