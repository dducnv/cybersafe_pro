...
class StatisticLocale extends BaseLocale {
  ...
  Map<String, String> get en => {
    ...
    StatisticText.weakPasswords: 'Weak',
  ...
  Map<String, String> get pt => {
    ...
    StatisticText.weakPasswords: 'Fraca',
    StatisticText.duplicatePasswords: 'Duplicada',
    StatisticText.strongPasswords: 'Forte',
    ...
    StatisticText.twoFactorEnabled: 'Autenticação em Dois Fatores',
  ...
  Map<String, String> get hi => {
    ...
    StatisticText.weakPasswords: 'कमजोर',
    StatisticText.duplicatePasswords: 'डुप्लिकेट',
    StatisticText.strongPasswords: 'मजबूत',
  ...
  Map<String, String> get ru => {
    ...
    StatisticText.weakPasswords: 'Слабый',
    StatisticText.duplicatePasswords: 'Дубликат',
    StatisticText.strongPasswords: 'Надежный',
    ...
    StatisticText.totalAccount: 'Всего аккаунтов',
    StatisticText.totalAccountPasswordStrong: 'Всего надежных паролей',
    StatisticText.totalAccountPasswordWeak: 'Всего слабых паролей',
    StatisticText.totalAccountSamePassword: 'Всего дублирующихся паролей',
  };
