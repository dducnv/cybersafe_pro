...
class DataManagerServiceNew {
  static final DataManagerServiceNew _instance = DataManagerServiceNew._internal();
  factory DataManagerServiceNew() => _instance;
  DataManagerServiceNew._internal();

  static Future<bool> deleteAllData(BuildContext context) async {
    try {
