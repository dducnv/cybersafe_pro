...
class EncryptionConfig {
  ...
  static bool isValidKeyPurpose(String purpose) {
    return KEY_PURPOSES.containsKey(purpose) || KEY_PURPOSES.containsValue(purpose);
  }

  static bool isValidEncryptionContext(String context) {
    return ENCRYPTION_CONTEXTS.containsKey(context) || ENCRYPTION_CONTEXTS.containsValue(context);
  }
